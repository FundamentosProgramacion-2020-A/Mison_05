...
# Dibujar figuras de 600x600 con ciclo for usando las librerías PIL/turtle.
#Usar ciclo while
...
def dibujarCuadrosCirculos(canvas):
    ...
    for i in range(0, 301, 10):
        puntoA = (i, i)
        puntoB = (i+a, i+a)
        canvas.line(puntoA+(i+a, i) + puntoB+(i,i+a) + (i,i), "black")
...
def main():
    ...
    while opcion != 0:
        if opcion == 1:
            ...
            print("ERROR, debes teclear 1, 2, 3, 4, 5 o 6 como opciones")
